...
export const BIBLE_TRANSLATIONS: BibleTranslation[] = [
  {
    ...
    shortName: "KJV",
    description: "The classic 1611 English translation, known for its poetic and majestic language. Widely used across denominations.",
    language: "English",
  },
  {
    id: "web",
    ...
    shortName: "WEB",
    description: "A modern, easy-to-read public domain translation. Great for everyday reading and study.",
    language: "English",
  },
  {
    id: "asv",
    ...
    shortName: "ASV",
    description: "A literal, word-for-word translation from 1901. Valued for its accuracy to the original texts.",
    language: "English",
  },
  {
    id: "bbe",
    ...
    shortName: "BBE",
    description: "Uses a limited vocabulary of 1,000 words for maximum clarity. Perfect for new readers.",
    language: "English",
  },
  {
    id: "darby",
    name: "Darby Bible",
    shortName: "Darby",
    description: "A highly literal translation by John Nelson Darby. Favored for deep word study.",
    language: "English",
  },
  {
    id: "ylt",
    ...
    shortName: "YLT",
    description: "Extremely literal, preserving the original verb tenses. New Testament only.",
    language: "English",
  },
];
