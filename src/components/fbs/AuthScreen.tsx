      ...
      >
        ...
        <div className="w-full max-w-[430px] px-8 pb-12 space-y-3">
          ...
          <p className="text-[10px] text-center text-gray-500 leading-relaxed pt-1">
            ...
            <a href="/terms" className="underline" onClick={(e) => { e.stopPropagation(); }}>Terms of Service</a>{" "}
            and{" "}
            <a href="/privacy" className="underline" onClick={(e) => { e.stopPropagation(); }}>Privacy Policy</a>
          </p>
        </div>
      </div>
    );
