  ...
  return (
    <div className="min-h-screen px-6 py-14 max-w-2xl mx-auto" style={{ background: "hsl(var(--background))" }}>
      ...
      <div className="space-y-6 text-sm text-foreground/85 leading-relaxed">
        ...
        <section>
          <h2 className="text-base font-semibold text-foreground mb-2">7. Disclaimers</h2>
        ...
        <section>
          ...
          <p>We reserve the right to suspend or terminate accounts that violate these terms. You may delete your account at any time through the app settings.</p>
        </section>
